    ...
    <Section name="about" className={style.root}>
      ...
      <Container grid>
        <Row start={1} end={3}>
          <ContentBlock>
            <List>
              <ListItem end="x2092">Awwwards</ListItem>
              <ListItem end="x1876">CSS Design Awards</ListItem>
              <ListItem end="x511">FWA</ListItem>
              <ListItem end="x713">iF Design Award</ListItem>
              <ListItem end="x98">Other</ListItem>
            </List>
          </ContentBlock>
        </Row>
      </Container>
